        ...
        loadQuote(){
            ...
            xhr.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    document.querySelector(".quote-body-text").innerHTML = '"' + _this.removeTag(res.content) + '"';
                    document.querySelector(".quote-author").innerHTML = "-" + res.title;
                }
            };

            xhr.open("GET", "https://quotesondesign.com/wp-json/posts?filter[orderby]=rand&filter[posts_per_page]=1&callback=");
            xhr.send();
        }
